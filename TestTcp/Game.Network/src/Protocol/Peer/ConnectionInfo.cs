...
namespace Game.Network.Protocol
{
    ...
    {
        public static ConnectionInfoCodec Codec = new();
        ...
        public readonly int playerPlayformSize;
        public readonly int appVersionSize;
        ...
        )
        {
            ...
            playerPlatformId = platformId ?? String.Empty;
            appVersion = app_version ?? String.Empty;
            token = Token ?? String.Empty;

            playerPlayformSize = Encoding.UTF8.GetByteCount(playerPlatformId);
            appVersionSize = Encoding.UTF8.GetByteCount(appVersion);
            tokenSize = Encoding.UTF8.GetByteCount(token);
        } 
